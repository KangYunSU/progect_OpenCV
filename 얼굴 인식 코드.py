...
#image = cv.imread('images/APINK.jpg', cv.IMREAD_COLOR)
#image = cv.imread('images/dahyun.jpg', cv.IMREAD_COLOR)
#image = cv.imread('images/IM.png', cv.IMREAD_COLOR)
#image = cv.imread('images/smile.png', cv.IMREAD_COLOR)

doggy_ear = cv.imread('images/doggy_ear.png', cv.IMREAD_UNCHANGED)
doggy_nose = cv.imread('images/doggy_nose.png', cv.IMREAD_UNCHANGED)
rabbit_ear = cv.imread('images/rabbit_ear.png', cv.IMREAD_UNCHANGED)
sunglass_1 = cv.imread('images/sunglass_1.png', cv.IMREAD_UNCHANGED)
sunglass_2 = cv.imread('images/sunglass_2.png', cv.IMREAD_UNCHANGED)
...
while True:
    ...
    if smile_flag ==True:
        draw.text((10, 10),  "스마일", font=ImageFont.truetype("./malgun.ttf", 48), fill=(128,128,0))
    else:
        draw.text((10, 10),  "노스마일", font=ImageFont.truetype("./malgun.ttf", 48), fill=(128,128,0))
